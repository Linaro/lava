...
then
  ...
  pylint \
    ...
    --recursive y \
    --disable=all \
    --enable=elif,exceptions,stdlib,imports,variables,string,string_constant,logging,newstyle,classes \
    --disable=C0411,C0412,C0415,E0401,E0611,E0202,E0307,R0401,W \
    --enable=R1707,R1714,R1715,R1716,W0235,W0404,W0611,W1401,W1402,W1403,W1505 \
    $dirs
fi
