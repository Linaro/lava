...
then
  ...
  set -x
  dirs=${*:-lava lava_common lava_dispatcher lava_rest_app lava_results_app lava_scheduler_app lava_server linaro_django_xmlrpc share tests lava/dispatcher/lava-run lava/dispatcher/lava-worker}
