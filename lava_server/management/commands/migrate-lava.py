...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--app_label", help="App label of an application to synchronize the state."
        )
        parser.add_argument(
            "--migration_name",
            help=(
        ...
        parser.add_argument(
            ...
            "(the SQL generated is thrown away at the last minute)",
        )
    ...
    def handle(self, *args, **options):
        ...
        # to do at this point.
        emit_post_migrate_signal(
            created_models, self.verbosity, self.interactive, connection.alias
        )
    ...
    def sync_apps(self, connection, app_labels):
        ...
        try:
            ...
            emit_pre_migrate_signal(
                create_models, self.verbosity, self.interactive, connection.alias
            )
