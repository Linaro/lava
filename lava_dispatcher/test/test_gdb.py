...
class TestGDB(StdoutTestCase):
    ...
    def test_validate_errors(self):
        ...
        with self.assertRaises(JobError):
            job.validate()
        self.assertEqual(job.pipeline.errors, ["Requesting a docker container while docker is not used for this device"])
    ...
    def test_without_docker(self):
        ...
        self.assertEqual(action.commands[0], "target remote | openocd -c \"gdb_port pipe\" -f {OPENOCD_SCRIPT}")
