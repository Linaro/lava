...
class Action:
    ...
    def get_constant(self, key: str, prefix: str) -> Any:
    ...
    def run_cmd(
        ...
        try:
            proc = PexpectPopenSpawn(
                ...
                env=env,  # type: ignore[arg-type,unused-ignore]
            )
    ...
    def get_namespace_keys(
        ...
        action_params: dict[str, Any] = self.data.get(namespace, {}).get(action, {})
        return action_params.keys()
