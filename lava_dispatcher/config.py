...
class DeviceSchema(schema.Schema):
    ...
    test_image_prompts = schema.ListOption(default=["\(initramfs\)",
                                                    ...
                                                    "root@master",
                                                    "sh-4.2#"])
    bootloader_prompt_is_re = schema.BoolOption(default=False)
    bootloader_prompt_test_send = schema.StringOption()
    bootloader_prompt_test_response= schema.StringOption()
