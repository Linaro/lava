...
https://git.lavasoftware.org/lava/lava/blob/master/lava_scheduler_app/tests/devices/bbb-01.yaml
...
`base.jinja2
<https://git.lavasoftware.org/lava/lava/blob/master/lava_scheduler_app/tests/device-types/base.jinja2>`_
template and existing examples (e.g. `beaglebone-black
<https://git.lavasoftware.org/lava/lava/blob/master/lava_scheduler_app/tests/device-types/beaglebone-black.jinja2>`_)
...
<https://git.lavasoftware.org/lava/lava/blob/master/lava_scheduler_app/tests/devices/bbb-01.yaml>`_
