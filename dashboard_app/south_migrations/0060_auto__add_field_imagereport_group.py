...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageReport.group'
        db.add_column(u'dashboard_app_imagereport', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.Group'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ImageReport.group'
        db.delete_column(u'dashboard_app_imagereport', 'group_id')
