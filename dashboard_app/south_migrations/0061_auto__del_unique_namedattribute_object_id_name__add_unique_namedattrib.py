...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'dashboard_app_namedattribute', ['object_id', 'name'])

        # Adding unique constraint on 'NamedAttribute', fields ['object_id', 'name', 'content_type']
        db.create_unique(u'dashboard_app_namedattribute', ['object_id', 'name', 'content_type_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'NamedAttribute', fields ['object_id', 'name', 'content_type']
        db.delete_unique(u'dashboard_app_namedattribute', ['object_id', 'name', 'content_type_id'])

        # Adding unique constraint on 'NamedAttribute', fields ['object_id', 'name']
        db.create_unique(u'dashboard_app_namedattribute', ['object_id', 'name'])
    ...
    models = {
        ...
        u'dashboard_app.imagechartfilter': {
            ...
            'is_all_tests_included': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'dashboard_app.imagereportchart': {
            'Meta': {'ordering': "['relative_index']", 'unique_together': "(('image_report', 'name'),)", 'object_name': 'ImageReportChart'},
            'chart_height': ('django.db.models.fields.PositiveIntegerField', [], {'default': '300'}),
            ...
            'is_aggregate_results': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_build_number': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'relative_index': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'target_goal': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '5', 'blank': 'True'}),
            'xaxis_attribute': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'dashboard_app.namedattribute': {
            'Meta': {'unique_together': "(('object_id', 'name', 'content_type'),)", 'object_name': 'NamedAttribute'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_manual': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        u'dashboard_app.testrunfiltertest': {
            ...
            'test': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'testrunfilters'", 'to': u"orm['dashboard_app.Test']"})
        },
        u'dashboard_app.testrunfiltertestcase': {
            ...
            'test_case': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'testrunfilters'", 'to': u"orm['dashboard_app.TestCase']"})
        }
    }
