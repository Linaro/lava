...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageChartUser.is_delta'
        db.add_column(u'dashboard_app_imagechartuser', 'is_delta',
    ...
    def backwards(self, orm):
        # Deleting field 'ImageChartUser.is_delta'
        db.delete_column(u'dashboard_app_imagechartuser', 'is_delta')

        # Adding field 'ImageReportChart.is_delta'
        db.add_column(u'dashboard_app_imagereportchart', 'is_delta',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
