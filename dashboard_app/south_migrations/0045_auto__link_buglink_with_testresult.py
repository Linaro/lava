...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field test_result on 'BugLink'
        db.create_table('dashboard_app_buglink_test_result', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('buglink', models.ForeignKey(orm['dashboard_app.buglink'], null=False)),
            ('testresult', models.ForeignKey(orm['dashboard_app.testresult'], null=False))
        ))
        db.create_unique('dashboard_app_buglink_test_result', ['buglink_id', 'testresult_id'])

    def backwards(self, orm):
        # Removing M2M table for field test_result on 'BugLink'
        db.delete_table('dashboard_app_buglink_test_result')
    ...
    models = {
        ...
        'dashboard_app.buglink': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'test_result': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'bug_links'", 'blank': 'True', 'to': "orm['dashboard_app.TestResult']"}),
            'test_runs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'bug_links'", 'blank': 'True', 'to': "orm['dashboard_app.TestRun']"})
        },
