...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestResult.measurement'
        db.alter_column(u'dashboard_app_testresult', 'measurement', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'TestResult.measurement'
        db.alter_column(u'dashboard_app_testresult', 'measurement', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=10))
