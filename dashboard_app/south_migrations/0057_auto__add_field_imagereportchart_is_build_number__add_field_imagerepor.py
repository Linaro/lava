...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageReportChart.is_build_number'
        db.add_column(u'dashboard_app_imagereportchart', 'is_build_number',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ImageReportChart.xaxis_attribute'
        db.add_column(u'dashboard_app_imagereportchart', 'xaxis_attribute',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ImageReportChart.relative_index'
        db.add_column(u'dashboard_app_imagereportchart', 'relative_index',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ImageReportChart.is_build_number'
        db.delete_column(u'dashboard_app_imagereportchart', 'is_build_number')

        # Deleting field 'ImageReportChart.xaxis_attribute'
        db.delete_column(u'dashboard_app_imagereportchart', 'xaxis_attribute')

        # Deleting field 'ImageReportChart.relative_index'
        db.delete_column(u'dashboard_app_imagereportchart', 'relative_index')
    ...
    models = {
        ...
        u'dashboard_app.imagereportchart': {
            ...
            'is_aggregate_results': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_build_number': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
