...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageChartTestAttributeUser'
        db.create_table(u'dashboard_app_imagecharttestattributeuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_chart_test_attribute', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard_app.ImageChartTestAttribute'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('is_visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'dashboard_app', ['ImageChartTestAttributeUser'])

        # Adding unique constraint on 'ImageChartTestAttributeUser', fields ['image_chart_test_attribute', 'user']
        db.create_unique(u'dashboard_app_imagecharttestattributeuser', ['image_chart_test_attribute_id', 'user_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'ImageChartTestAttributeUser', fields ['image_chart_test_attribute', 'user']
        db.delete_unique(u'dashboard_app_imagecharttestattributeuser', ['image_chart_test_attribute_id', 'user_id'])

        # Deleting model 'ImageChartTestAttributeUser'
        db.delete_table(u'dashboard_app_imagecharttestattributeuser')
    ...
    models = {
        ...
        u'dashboard_app.bundle': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deserialized': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'dashboard_app.imagechartuser': {
            ...
            'toggle_percentage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        ...
        u'dashboard_app.testrun': {
            ...
            'time_check_performed': ('django.db.models.fields.BooleanField', [], {})
        },
