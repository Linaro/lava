...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NamedAttribute.is_manual'
        db.add_column(u'dashboard_app_namedattribute', 'is_manual',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'NamedAttribute.is_manual'
        db.delete_column(u'dashboard_app_namedattribute', 'is_manual')
