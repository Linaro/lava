...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageReportChart.is_aggregate_results'
        db.add_column(u'dashboard_app_imagereportchart', 'is_aggregate_results',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ImageReportChart.is_aggregate_results'
        db.delete_column(u'dashboard_app_imagereportchart', 'is_aggregate_results')
