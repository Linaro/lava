...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageChartTestCaseUser'
        db.create_table(u'dashboard_app_imagecharttestcaseuser', (
        ...
        db.send_create_signal(u'dashboard_app', ['ImageChartTestCaseUser'])

        # Adding unique constraint on 'ImageChartTestCaseUser', fields ['image_chart_test_case', 'user']
        db.create_unique(u'dashboard_app_imagecharttestcaseuser', ['image_chart_test_case_id', 'user_id'])

        # Adding model 'ImageChartTestUser'
        db.create_table(u'dashboard_app_imagecharttestuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image_chart_test', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard_app.ImageChartTest'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('is_visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'dashboard_app', ['ImageChartTestUser'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'ImageChartTestCaseUser', fields ['image_chart_test_case', 'user']
        db.delete_unique(u'dashboard_app_imagecharttestcaseuser', ['image_chart_test_case_id', 'user_id'])

        # Deleting model 'ImageChartTestCaseUser'
        db.delete_table(u'dashboard_app_imagecharttestcaseuser')
