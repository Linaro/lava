...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BugLink'
        db.create_table('dashboard_app_buglink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bug_link', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True)),
        ))
        db.send_create_signal('dashboard_app', ['BugLink'])

        # Adding M2M table for field test_runs on 'BugLink'
        db.create_table('dashboard_app_buglink_test_runs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('buglink', models.ForeignKey(orm['dashboard_app.buglink'], null=False)),
            ('testrun', models.ForeignKey(orm['dashboard_app.testrun'], null=False))
        ))
        db.create_unique('dashboard_app_buglink_test_runs', ['buglink_id', 'testrun_id'])

    def backwards(self, orm):
        # Deleting model 'BugLink'
        db.delete_table('dashboard_app_buglink')

        # Removing M2M table for field test_runs on 'BugLink'
        db.delete_table('dashboard_app_buglink_test_runs')
    ...
    models = {
        ...
        'dashboard_app.buglink': {
            'Meta': {'object_name': 'BugLink'},
            'bug_link': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'test_runs': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'bug_links'", 'symmetrical': 'False', 'to': "orm['dashboard_app.TestRun']"})
        },
