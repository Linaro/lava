...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageChartUser'
        db.create_table('dashboard_app_imagechartuser', (
            ...
            ('is_legend_visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('dashboard_app', ['ImageChartUser'])
