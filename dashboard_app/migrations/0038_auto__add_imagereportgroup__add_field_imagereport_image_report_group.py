...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageReportGroup'
        db.create_table('dashboard_app_imagereportgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=1024)),
        ))
        db.send_create_signal('dashboard_app', ['ImageReportGroup'])

        # Adding field 'ImageReport.image_report_group'
        db.add_column('dashboard_app_imagereport', 'image_report_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['dashboard_app.ImageReportGroup'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ImageReportGroup'
        db.delete_table('dashboard_app_imagereportgroup')

        # Deleting field 'ImageReport.image_report_group'
        db.delete_column('dashboard_app_imagereport', 'image_report_group_id')
