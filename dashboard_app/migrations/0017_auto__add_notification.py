...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dashboard_app_notification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bundle_stream', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard_app.BundleStream'])),
            ('testcase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard_app.TestCase'], null=True, blank=True)),
            ('if_notify', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('dashboard_app', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table('dashboard_app_notification')
