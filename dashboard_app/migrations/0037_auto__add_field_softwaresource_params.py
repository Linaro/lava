...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestResult.comments'
        db.add_column('dashboard_app_softwaresource', 'default_params',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)
        db.add_column('dashboard_app_softwaresource', 'test_params',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'softwaresource.comments'
        db.delete_column('dashboard_app_softwaresource', 'default_params')
        db.delete_column('dashboard_app_softwaresource', 'test_params')
