...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageChartUser.has_subscription'
        db.add_column('dashboard_app_imagechartuser', 'has_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ImageChartUser.has_subscription'
        db.delete_column('dashboard_app_imagechartuser', 'has_subscription')
