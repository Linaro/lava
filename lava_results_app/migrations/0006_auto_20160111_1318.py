...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('chart_type', models.CharField(default='pass/fail', max_length=20, verbose_name='Chart type', choices=[('pass/fail', 'Pass/Fail'), ('measurement', 'Measurement'), ('attributes', 'Attributes')])),
                ('target_goal', models.DecimalField(null=True, verbose_name='Target goal', max_digits=10, decimal_places=5, blank=True)),
                ('chart_height', models.PositiveIntegerField(default=300, verbose_name='Chart height', validators=[django.core.validators.MinValueValidator(200), django.core.validators.MaxValueValidator(400)])),
                ('is_percentage', models.BooleanField(default=False, verbose_name='Percentage')),
                ('chart_visibility', models.CharField(default='chart', max_length=20, verbose_name='Chart visibility', choices=[('chart', 'Chart only'), ('table', 'Result table only'), ('both', 'Both')])),
                ('xaxis_attribute', models.CharField(max_length=20, null=True, verbose_name='X-axis attribute', blank=True)),
                ('representation', models.CharField(default='lines', max_length=20, verbose_name='Representation', choices=[('lines', 'Lines'), ('bars', 'Bars')])),
                ('relative_index', models.PositiveIntegerField(default=0, verbose_name='Order in the chart')),
                ('attributes', models.CharField(max_length=200, null=True, verbose_name='Chart attributes', blank=True)),
