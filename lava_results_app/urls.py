...
urlpatterns = patterns(
    ...
    url(r'^query/~(?P<username>[^/]+)/(?P<name>[a-zA-Z0-9-_]+)/\+add-group$', 'query.views.query_add_group', name='query_add_group'),
    url(r'^query/~(?P<username>[^/]+)/(?P<name>[a-zA-Z0-9-_]+)/\+select-group$', 'query.views.query_select_group', name='query_select_group'),
    url(r'^query/get-query-groups$', 'query.views.query_group_list', name='query_group_list'),
    url(r'^query/\+get-group-names$', 'query.views.get_group_names'),
