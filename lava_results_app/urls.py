...
urlpatterns = [
    ...
    url(r'^(?P<job>[0-9]+|[0-9]+.[0-9]+)/(?P<pk>[-_a-zA-Z0-9.]+)/\+testcase-count$',
        suite_testcase_count, name='lava.results.suite_testcase_count'),
    url(r'^testcase/(?P<case_id>[0-9]+)$',
        testcase, name='lava.results.testcase'),
    url(r'^(?P<job>[0-9]+|[0-9]+.[0-9]+)/(?P<pk>[-_a-zA-Z0-9.]+)/(?P<case_id>[0-9]+)$',
        testcase, name='lava.results.testcase'),
