...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QueryCondition.value'
        db.alter_column(u'lava_results_app_querycondition', 'value', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding field 'Query.is_live'
        db.add_column(u'lava_results_app_query', 'is_live',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Query.is_changed'
        db.add_column(u'lava_results_app_query', 'is_changed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Query.is_updating'
        db.add_column(u'lava_results_app_query', 'is_updating',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Query.last_updated'
        db.add_column(u'lava_results_app_query', 'last_updated',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'QueryCondition.value'
        db.alter_column(u'lava_results_app_querycondition', 'value', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Deleting field 'Query.is_live'
        db.delete_column(u'lava_results_app_query', 'is_live')

        # Deleting field 'Query.is_changed'
        db.delete_column(u'lava_results_app_query', 'is_changed')

        # Deleting field 'Query.is_updating'
        db.delete_column(u'lava_results_app_query', 'is_updating')

        # Deleting field 'Query.last_updated'
        db.delete_column(u'lava_results_app_query', 'last_updated')
    ...
    models = {
        ...
        u'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'qejgfzsj84krtbrr7rj2th43mljmfsae17thbgbsijmsqczl3rjfy7zfipb4dn46eugnqq9alahgc5yhyznlb5yym30i25mfn5y0pzpchuaycnlcerymoqpfhzcy24jc'", 'unique': 'True', 'max_length': '128'}),
