...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lava_results_app_querycondition', 'value', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        u'lava_results_app.querycondition': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'operator': ('django.db.models.fields.CharField', [], {'default': "'exact'", 'max_length': '20'}),
        ...
        u'lava_results_app.testcase': {
            ...
            'suite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lava_results_app.TestSuite']"}),
        ...
        u'lava_results_app.testdata': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'testjob': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lava_scheduler_app.TestJob']"})
        },
        ...
        u'lava_results_app.testsuite': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['lava_scheduler_app.TestJob']"}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'xfeehij66gtx21fsu06x4euiytbw5md17chxlwypcpmbo41ki7hxyrkm1wdgp42mo1u8mjb9x5pru1g6b68hcec5jcrro0mbhkc10os7hu3x601f0k5d0np028tbluc8'", 'unique': 'True', 'max_length': '128'}),
