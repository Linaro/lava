...
worker: sudo PYTHONPATH=. python3 lava/dispatcher/lava-worker --level DEBUG --log-file - --url http://localhost:8000/ --ws-url http://localhost:8001/ws/ --worker-dir $(pwd)/tmp/worker $LAVA_WORKER_OPTS
