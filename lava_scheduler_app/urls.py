...
from lava_scheduler_app.views import (
    ...
    device_edit_description, device_force_health_check, device_health_history_log,
    ...
    job_log_incremental, job_log_pipeline_incremental, job_output,
    job_pipeline_incremental, job_pipeline_sections, job_resubmit, job_section_log,
    job_status, job_submit, job_submit_wizard, job_toggle_favorite, lab_health,
    longest_jobs, multinode_job_definition, multinode_job_definition_plain,
    mydevice_list, mydevice_type_health_history_log, myjobs, online_device_list,
...
urlpatterns = [
    ...
    url(r'^job/(?P<pk>[0-9]+)/definition$', job_definition,
        name='lava.scheduler.job.definition'),
    url(r'^job/(?P<pk>[0-9]+)/definition/plain$', job_definition_plain,
        name='lava.scheduler.job.definition.plain'),
    url(r'^job/(?P<pk>[0-9]+)/description$', job_description_yaml,
    ...
    url(r'^job/(?P<pk>[0-9]+)/expanded_definition$',
        expanded_job_definition,
        name='lava.scheduler.job.expanded_definition'),
    url(r'^job/(?P<pk>[0-9]+)/expanded_definition/plain$',
        vmgroup_job_definition_plain,
    ...
    url(r'^job/(?P<pk>[0-9]+)/log_file/plain$', job_log_file_plain,
        name='lava.scheduler.job.log_file.plain'),
    url(r'^job/(?P<pk>[0-9]+)/pipeline_incremental$',
        job_pipeline_incremental,
        name='lava.scheduler.job_pipeline_incremental'),
    url(r'^job/(?P<pk>[0-9]+)/pipeline_sections$',
        job_pipeline_sections,
        name='lava.scheduler.job_pipeline_sections'),
    url(r'^job/(?P<pk>[0-9]+)/job_status$', job_status, name='lava.scheduler.job_status'),
    url(r'^job/(?P<pk>[0-9]+|[0-9]+.[0-9]+)/complete_log$', job_complete_log,
        name='lava.scheduler.job.complete_log'),
    url(r'^job/(?P<job>[0-9]+)(/download/)(?P<log_name>[-_a-zA-Z0-9.]+)$',
        job_section_log,
        name='lava.scheduler.job.section_log'),
    url(r'^job/(?P<pk>[0-9]+)/cancel$', job_cancel, name='lava.scheduler.job.cancel'),
    url(r'^job/(?P<pk>[0-9]+)/resubmit$', job_resubmit, name='lava.scheduler.job.resubmit'),
    url(r'^job/(?P<pk>[0-9]+)/annotate_failure$', job_annotate_failure,
        name='lava.scheduler.job.annotate_failure'),
    url(r'^job/(?P<pk>[0-9]+)/toggle_favorite$',
        job_toggle_favorite,
        name='lava.scheduler.job.toggle_favorite'),
    url(r'^job/(?P<pk>[0-9]+)/json$', job_json, name='lava.scheduler.job.json'),
    ...
    url(r'^job/(?P<pk>[0-9]+)/log_pipeline_incremental$',
    ...
    url(r'^get-remote-json', get_remote_json,
    ...
    url(r'^job/(?P<pk>[0-9]+)/priority$', job_change_priority,
