...
urlpatterns = patterns(
    ...
    url(r'^jobsubmitwizard$',
        'job_submit_wizard',
        name='lava.scheduler.job.submit_wizard'),
    ...
    url(r'^longestjobs$',
        'longest_jobs',
        name='lava.scheduler.longest_jobs'),
    ...
    url(r'^job/(?P<pk>[0-9]+)/description$',
    ...
    url(r'^job/(?P<pk>[0-9]+)/job_status$',
        'job_status',
        name='lava.scheduler.job_status'),
    url(r'^job/(?P<pk>[0-9]+)/complete_log$',
        'job_complete_log',
    ...
    url(r'^favorite-jobs/~(?P<username>[^/]+)$',
        'favorite_jobs',
        name='lava.scheduler.favorite_jobs'),
    ...
    url(r'^alldevices/online$',
        'online_device_list',
        name='lava.scheduler.online_devices'),
    url(r'^alldevices/passinghealthchecks$',
    ...
    url(r'^pipeline$',
        'pipeline',
        name='lava.scheduler.pipeline'),
    url(r'^healthcheck$',
        'healthcheck',
        name='lava.scheduler.healthcheck'),
    url(r'^running$',
        'running',
        name='lava.scheduler.running'),
