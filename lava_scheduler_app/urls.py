...
from lava_scheduler_app.views import (
    ...
    device_reports, device_restrict_device, device_type_detail, device_dictionary,
    device_type_health_history_log, device_type_reports, edit_transition, edit_worker_desc,
    expanded_job_definition, failure_report, favorite_jobs, get_remote_definition,
    ...
    job_pipeline_incremental, job_pipeline_sections, job_pipeline_timing,
    ...
    multinode_job_definition_plain, mydevice_list,
    mydevices_health_history_log, myjobs, online_device_list,
