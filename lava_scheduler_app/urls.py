...
from lava_scheduler_app.views import (
    ...
    job_log_incremental, job_output, job_pipeline_incremental, job_pipeline_sections,
...
urlpatterns = [
    ...
    url(r'^job/(?P<pk>[0-9]+)/log_file$', job_log_file,
    ...
    url(r'^job/(?P<pk>[0-9]+)/complete_log$', job_complete_log,
