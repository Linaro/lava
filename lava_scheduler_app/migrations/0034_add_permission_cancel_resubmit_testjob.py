...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='testjob', app_label='lava_scheduler_app')
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='cancel_resubmit_testjob', defaults=dict(name=u'Can cancel or resubmit test jobs'))
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'37n4kz0oyqmxldqtsaan7mp0fhngrmb9i8woau4q3t5u8fo0cpfc1000x40t07xxnc0e20rn05iujrlpt7zm2lle4esflh0snicd35bac4feuslt9fuextb80ydag3ob'", 'unique': 'True', 'max_length': '128'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auth_tokens'", 'to': "orm['auth.User']"})
        }
    }

    complete_apps = ['contenttypes', 'auth', 'lava_scheduler_app']
    symmetrical = True
