...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestJob.vm_group'
        db.add_column('lava_scheduler_app_testjob', 'vm_group',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestJob.vmgroup_definition'
        db.add_column('lava_scheduler_app_testjob', 'vmgroup_definition',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TestJob.vm_group'
        db.delete_column('lava_scheduler_app_testjob', 'vm_group')

        # Deleting field 'TestJob.vmgroup_definition'
        db.delete_column('lava_scheduler_app_testjob', 'vmgroup_definition')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'hxs2p0qrxwnu0jrmfioxqaenda68nu777bamwbiw11xdwa55y2crcdbs5dpos5ygr910kdr9zaf9rlu1qhz90w3c7qeunja6tgtb99pakd8utstbd0djt6lzpfui9w1y'", 'unique': 'True', 'max_length': '128'}),
