...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestJob.original_definition'
        db.add_column('lava_scheduler_app_testjob', 'original_definition',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TestJob.original_definition'
        db.delete_column('lava_scheduler_app_testjob', 'original_definition')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'am0jsur0zjr500gemwa6zsmzb33he06ymo028i6us3wumkhblffu3rb8e3wnb6f6m75l1si55qna1uf5ugjkhy2gfgfwkrby9mxyqni9xyon6rhzqqhp0xhpbapbgzef'", 'unique': 'True', 'max_length': '128'}),
