...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.last_master_scheduler_tick'
        db.add_column('lava_scheduler_app_worker', 'last_master_scheduler_tick',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Worker.last_master_scheduler_tick'
        db.delete_column('lava_scheduler_app_worker', 'last_master_scheduler_tick')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'0kk4s52y93w8fyk27ec59jt1w3ot741ghei0rc762z3myoynxoem6b1fmcdatzqunb6wad4slro20hkwxn3msia1crflk0q3ydfql7fa070i2jqerl8lxiugqr0w3hay'", 'unique': 'True', 'max_length': '128'}),
