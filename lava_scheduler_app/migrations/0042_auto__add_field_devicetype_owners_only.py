...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.owners_only'
        db.add_column(u'lava_scheduler_app_devicetype', 'owners_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DeviceType.owners_only'
        db.delete_column(u'lava_scheduler_app_devicetype', 'owners_only')
    ...
    models = {
        ...
        u'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'k7hu0rwfbiz5d1b622a6etqomy2aqwy5d4hak8hhskdn5fk60pgr4luilujormu6wy4we1kg6co6s6n98l6z78d93acq4tgxjp966eq1gjk56lirbxiyacaklgpyctmb'", 'unique': 'True', 'max_length': '128'}),
