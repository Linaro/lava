...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.display'
        db.add_column('lava_scheduler_app_worker', 'display',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Worker.display'
        db.delete_column('lava_scheduler_app_worker', 'display')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'q001rbbgspugzam4f0jy017mzb9skyzup2242w2eb0sb77nqtygy9k1ygub8a10yz1j6ecalnmzo7zbkih3db09z4brqdcd8q14n5eze8wdcw5u0087bd1bm634pzx2q'", 'unique': 'True', 'max_length': '128'}),
