...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeviceHealth.last_report_time'
        db.add_column('lava_scheduler_app_devicehealth', 'last_report_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 1, 18, 19, 14, 50, 893868)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeviceHealth.last_report_time'
        db.delete_column('lava_scheduler_app_devicehealth', 'last_report_time')
    ...
    models = {
        ...
        'lava_scheduler_app.devicehealth': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_report_time': ('django.db.models.fields.DateTimeField', [], {})
        },
