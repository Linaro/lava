...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestJobUser'
        db.create_table(u'lava_scheduler_app_testjobuser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('test_job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lava_scheduler_app.TestJob'])),
            ('is_favorite', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'lava_scheduler_app', ['TestJobUser'])
    ...
    models = {
        ...
        u'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'p62k0sopjm1h08hdcp0h9swkwxmlw8l45351yz9rouf42mr8udbrybeugy4ty4lzzgxao0w0dx35cnax52b171fszboxqcknkq0f151syk2k9u3b1db7t4j123p0q4b7'", 'unique': 'True', 'max_length': '128'}),
