...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Worker.software_info'
        db.add_column('lava_scheduler_app_worker', 'software_info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Worker.software_info'
        db.delete_column('lava_scheduler_app_worker', 'software_info')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'yoe1thif642ihigchcast0fu4s65oug7ekqwmcgm9h914yxkgix83wfxx40imewrpkgxpjwbu51e46juronncbudwd740z2m4nng5sai8x5070mpeoi8tq23d06axqt1'", 'unique': 'True', 'max_length': '128'}),
