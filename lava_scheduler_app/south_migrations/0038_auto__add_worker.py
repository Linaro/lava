...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Worker'
        db.create_table('lava_scheduler_app_worker', (
            ('hostname', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default=None, max_length=200, null=True, blank=True)),
            ('uptime', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('arch', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('platform', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('hardware_info', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('last_heartbeat', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('heartbeat', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lava_scheduler_app', ['Worker'])

    def backwards(self, orm):
        # Deleting model 'Worker'
        db.delete_table('lava_scheduler_app_worker')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'m0q0r8xj0nme2ugw0mh4owtls0jzdhta3q8qh7nwlg15dhncpbm0ihbf6rkh0fo5q0fq5qd2rzl5mqjkbcx0iwne0tbka0onljcd10w44ldot4thmd07pzgr3yjt5et7'", 'unique': 'True', 'max_length': '128'}),
