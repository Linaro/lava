...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestJob.notifications'
        db.add_column('lava_scheduler_app_testjob', 'admin_notifications',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TestJob.notifications'
        db.delete_column('lava_scheduler_app_testjob', 'admin_notifications')
    ...
    models = {
        ...
        'lava_scheduler_app.testjob': {
            ...
            'admin_notifications': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
