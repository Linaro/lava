...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.description'
        db.add_column(u'lava_scheduler_app_devicetype', 'description',
                      self.gf('django.db.models.fields.TextField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DeviceType.description'
        db.delete_column(u'lava_scheduler_app_devicetype', 'description')
    ...
    models = {
        ...
        u'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'na8sbhrgla8aiaryotgpk9u0io4gday2pkjq10p40l4xfdl55bewju3892e67i9dnrhq87i24dmm2dtieafpd9k6wzuow1bn6jrn1c6mqa00ynitn2fbhgaj5qm0anie'", 'unique': 'True', 'max_length': '128'}),
