...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Device.worker_hostname'
        db.delete_column('lava_scheduler_app_device', 'worker_hostname')

        # Adding field 'Device.worker_host'
        db.add_column('lava_scheduler_app_device', 'worker_host',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lava_scheduler_app.Worker'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Device.worker_hostname'
        db.add_column('lava_scheduler_app_device', 'worker_hostname',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Device.worker_host'
        db.delete_column('lava_scheduler_app_device', 'worker_host_id')
    ...
    models = {
        ...
        'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'noxgkjnh0pk6iwcn54sgzu6hg01e0di5g3chp0hlxtq1i0n2g6e0yjiu0gnrsg0b3fwy00581a3ywo6q6280wd05ykk9uabhbbfdkxae49td0njs08kky03mz5mn5eio'", 'unique': 'True', 'max_length': '128'}),
