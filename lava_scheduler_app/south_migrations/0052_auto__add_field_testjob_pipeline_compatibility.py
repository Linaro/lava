...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestJob.pipeline_compatibility'
        db.add_column(u'lava_scheduler_app_testjob', 'pipeline_compatibility',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TestJob.pipeline_compatibility'
        db.delete_column(u'lava_scheduler_app_testjob', 'pipeline_compatibility')
    ...
    models = {
        ...
        u'lava_scheduler_app.testjob': {
            ...
            'pipeline_compatibility': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'viewing_groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'viewing-groups'", 'default': 'None', 'to': u"orm['auth.Group']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        u'linaro_django_xmlrpc.authtoken': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'na04sa7sw4mbrqql15kj100l9oyo0y34ypwuqdiomq3qnj0e0fcbhrcofaki2ossaui4g0m3ph5darx7sak8c5h8mcjas5hpd8pq20btarph2p358ws160dh2d1ri0of'", 'unique': 'True', 'max_length': '128'}),
